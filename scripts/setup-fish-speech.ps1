...
# Step 1: リポジトリクローン
# =============================================================================
Write-Host "[1/5] Cloning Fish Speech repository..." -ForegroundColor Yellow
...
# Step 3: モデルダウンロード
# =============================================================================
Write-Host "[3/5] Downloading model weights..." -ForegroundColor Yellow
...
# =============================================================================
Write-Host "[4/5] Setting up reference audio directory..." -ForegroundColor Yellow
...
$launcherPath = Join-Path $projectRoot "scripts" "start-fish-speech.ps1"
$launcherContent = @"
# Fish Speech S2-Pro Server Launcher
# Generated by setup-fish-speech.ps1

`$fishSpeechDir = "$fishSpeechDir"
`$venvPython = "$venvPython"
`$port = $Port

Write-Host "Starting Fish Speech S2-Pro server on port `$port ..." -ForegroundColor Cyan
Write-Host "Press Ctrl+C to stop." -ForegroundColor Gray
Write-Host ""

Push-Location `$fishSpeechDir
try {
    & `$venvPython tools/api_server.py ``
...
Write-Host "     .\scripts\start-fish-speech.ps1" -ForegroundColor Cyan
